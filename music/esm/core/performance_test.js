...
test('From NoteSequence With Velocity', (t) => {
    const noteSequence = NoteSequence.create({
        quantizationInfo: { stepsPerSecond: 10 },
        notes: [
...
test('From NoteSequence With Quantized Velocity', (t) => {
    const noteSequence = NoteSequence.create({
        quantizationInfo: { stepsPerSecond: 10 },
        notes: [
            { pitch: 60, velocity: 100, quantizedStartStep: 0, quantizedEndStep: 40 },
...
test('From NoteSequence (Program and Drum Status)', (t) => {
    const noteSequence = NoteSequence.create({
        quantizationInfo: { stepsPerSecond: 10 },
        notes: [
...
test('To NoteSequence With Velocity', (t) => {
    const events = [
        { type: 'velocity-change', velocityBin: 100 },
        { type: 'note-on', pitch: 60 },
...
test('To NoteSequence With Quantized Velocity', (t) => {
    const events = [
        { type: 'velocity-change', velocityBin: 13 },
        { type: 'note-on', pitch: 60 },
        { type: 'note-on', pitch: 64 },
...
test('To NoteSequence With Unmatched Note-Offs', (t) => {
    const events = [
        { type: 'note-on', pitch: 60 },
        { type: 'note-on', pitch: 64 },
...
test('To NoteSequence With Unmatched Note-Ons', (t) => {
    const events = [
        { type: 'note-on', pitch: 60 },
        { type: 'note-on', pitch: 64 },
        { type: 'time-shift', steps: 10 },
...
test('To NoteSequence With Repeated Notes', (t) => {
    const events = [
        { type: 'note-on', pitch: 60 },
        { type: 'note-on', pitch: 64 },
        { type: 'time-shift', steps: 10 },
