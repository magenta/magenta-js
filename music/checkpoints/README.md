...
mel_2bar_multicontrol_tiny_fb0|MusicVAE|2-bar melody MusicVAE conditioned on chord, rhythm, shape, and register. Trained with 0 free bits.|11|[Right Click to Copy](https://storage.googleapis.com/magentadata/js/checkpoints/music_vae/mel_multicontrol/mel_2bar_multicontrol_tiny_fb0)
mel_2bar_multicontrol_tiny_fb8|MusicVAE|2-bar melody MusicVAE conditioned on chord, rhythm, shape, and register. Trained with 8 free bits.|11|[Right Click to Copy](https://storage.googleapis.com/magentadata/js/checkpoints/music_vae/mel_multicontrol/mel_2bar_multicontrol_tiny_fb8)
mel_2bar_multicontrol_tiny_fb16|MusicVAE|2-bar melody MusicVAE conditioned on chord, rhythm, shape, and register. Trained with 16 free bits.|11|[Right Click to Copy](https://storage.googleapis.com/magentadata/js/checkpoints/music_vae/mel_multicontrol/mel_2bar_multicontrol_tiny_fb16)
mel_2bar_multicontrol_tiny_fb32|MusicVAE|2-bar melody MusicVAE conditioned on chord, rhythm, shape, and register. Trained with 32 free bits.|11|[Right Click to Copy](https://storage.googleapis.com/magentadata/js/checkpoints/music_vae/mel_multicontrol/mel_2bar_multicontrol_tiny_fb32)
mel_rhythm_2bar_tiny_fb0|MusicVAE|2-bar MusicVAE model of melody rhythms. Trained with 0 free bits.|6|[Right Click to Copy](https://storage.googleapis.com/magentadata/js/checkpoints/music_vae/mel_multicontrol/mel_rhythm_2bar_tiny_fb0)
mel_rhythm_2bar_tiny_fb8|MusicVAE|2-bar MusicVAE model of melody rhythms. Trained with 8 free bits.|6|[Right Click to Copy](https://storage.googleapis.com/magentadata/js/checkpoints/music_vae/mel_multicontrol/mel_rhythm_2bar_tiny_fb8)
mel_rhythm_2bar_tiny_fb16|MusicVAE|2-bar MusicVAE model of melody rhythms. Trained with 16 free bits.|6|[Right Click to Copy](https://storage.googleapis.com/magentadata/js/checkpoints/music_vae/mel_multicontrol/mel_rhythm_2bar_tiny_fb16)
mel_rhythm_2bar_tiny_fb32|MusicVAE|2-bar MusicVAE model of melody rhythms. Trained with 32 free bits.|6|[Right Click to Copy](https://storage.googleapis.com/magentadata/js/checkpoints/music_vae/mel_multicontrol/mel_rhythm_2bar_tiny_fb32)
mel_shape_2bar_tiny_fb0|MusicVAE|2-bar MusicVAE model of melody shapes. Trained with 0 free bits.|6|[Right Click to Copy](https://storage.googleapis.com/magentadata/js/checkpoints/music_vae/mel_multicontrol/mel_shape_2bar_tiny_fb0)
mel_shape_2bar_tiny_fb8|MusicVAE|2-bar MusicVAE model of melody shapes. Trained with 8 free bits.|6|[Right Click to Copy](https://storage.googleapis.com/magentadata/js/checkpoints/music_vae/mel_multicontrol/mel_shape_2bar_tiny_fb8)
mel_shape_2bar_tiny_fb16|MusicVAE|2-bar MusicVAE model of melody shapes. Trained with 16 free bits.|6|[Right Click to Copy](https://storage.googleapis.com/magentadata/js/checkpoints/music_vae/mel_multicontrol/mel_shape_2bar_tiny_fb16)
mel_shape_2bar_tiny_fb32|MusicVAE|2-bar MusicVAE model of melody shapes. Trained with 32 free bits.|6|[Right Click to Copy](https://storage.googleapis.com/magentadata/js/checkpoints/music_vae/mel_multicontrol/mel_shape_2bar_tiny_fb32)
